...
export default function TimelineBullet({
  ...
  return (
    <div ref={ref} className="sticky top-24 self-start w-24 text-right">
      <div className="flex flex-col items-end gap-2">
        <motion.div
          className="relative h-14 w-14 self-end"
        ...
        >
          <div className="absolute right-0 top-0 flex h-14 w-14 items-center justify-center">
            <span className="absolute h-5 w-5 rounded-full bg-bg shadow-[0_0_0_5px_rgba(255,255,255,0.08)]" />
